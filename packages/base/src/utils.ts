 ...
 */
export
function put_buffers(state: {[key:string]: any}, buffer_paths: (string | number)[][], buffers: DataView[]) {
 ...
 */
export
function remove_buffers(state: {[key:string]: any}): {state: any, buffers: ArrayBuffer[], buffer_paths: (string | number)[][]} {
