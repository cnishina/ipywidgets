...
import {WidgetModel, unpack_models as widgetModelUnpackModels} from '../../lib/';
...
describe('unpack_models', () => {
    ...
    it('unpacks strings', async () => {
        ...
        let value = await widgetModelUnpackModels(serialized, this.manager);
...
describe('WidgetModel', () => {
    before(() => {
        this.asyncSetup = () => {
            ...
            this.widget.constructor.serializers = {
                times3: {
                    deserialize: (value: any, manager: any) => {
                        return value*3.0;
                    }
                },
                halve: {
    ...
    describe('send', () => {
        ...
        it.skip('sends custom messages with the right format', () => {
            let comm = new MockComm();
    ...
    describe('close', () => {
        ...
        it.skip('deletes the reference to the comm', () => {
            this.widget.close();
    ...
    describe('set', () => {
        ...
        // TODO(cnishina): this is an async method but the Backbone.Model has an on method that does not return a Promise
        // if the event takes longer than the tick, this will probably fail.
        it.skip('triggers change events', async() => {
